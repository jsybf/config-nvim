...
-- base01 = cursor line color
-- base02 = selection or background
-- base03 = comment color
-- base04 = line num
-- base05 = main text color: black
-- base06 = ?
-- base07 = ?
-- base08 = local variable name
-- base09 = enum or markdown code block
-- base0A = type
-- base0B = string literal
-- base0C = used in terminal
-- base0D = main text color
-- base0E = keyword
-- base0F = comma

-- stylua: ignore
local base16_gray = {
  gray        = '#ADAEB4',   dark_gray   = '#86868a',   black       = '#333333',   light_black = '#424141',
  blue        = '#1f56ad',   deep_blue   = '#282d8a',   purple      = '#721d96',   red         = '#833935',
  green       = '#457365',
}

-- stylua: ignore
local base16_gray_theme = {
  base00 = base16_gray.gray,        base01 = base16_gray.dark_gray,  base02 = base16_gray.dark_gray,  base03 = base16_gray.light_black,
  base04 = base16_gray.black,       base05 = base16_gray.black,      base06 = '#34ced9',              base07 = '#34ced9',
  base08 = base16_gray.blue,        base09 = base16_gray.black,      base0A = base16_gray.red,        base0B = base16_gray.green,
  base0C = base16_gray.light_black, base0D = base16_gray.black,      base0E = base16_gray.purple,     base0F = base16_gray.black,
}

-- stylua: ignore
local base16_black_theme = {
  base00 = '#000000', base01 = '#121212', base02 = '#222222', base03 = '#333333',
  base04 = '#999999', base05 = '#e0e0e0', base06 = '#999999', base07 = '#c1c1c1',
  base08 = '#5f8787', base09 = '#aaaaaa', base0A = '#e78a53', base0B = '#fbcb97',
  base0C = '#aaaaaa', base0D = '#e0e0e0', base0E = '#999999', base0F = '#444444',
}
...
-- ### what is this list
--     this is list of base16 colorscheme (https://github.com/RRethy/base16-nvim)
--
-- ### how to apply colorscheme
--     config = function ()
