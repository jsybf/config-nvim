...
--    if opts is nil                         -> write log in file with path of 'vim.g.gitp_log_path'. if vim.g.gitp_log_path not exists raise error
...
function Logger:new(writer_opt)
  ...
  local writer = (function()
    if writer_opt == nil then
      local log_file_path = vim.g.gitp_log_path
      if log_file_path == nil then
        error 'if opts is nil in Logger:new(opts) you should set vim.g.gitp_log_path'
      end
