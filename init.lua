...
vim.g.gitp_log_path = '/Users/gitp/dev/nvim.log'
...
require('lazy').setup({
  ...
  require 'colorscheme',
  require 'oil-conf',
  require 'telescope-conf.dir-telescope-conf',
  require 'nvim-cmp-conf',
  require 'git-conf',
  require 'plugins.git-diffview',
  require 'plugins.align-text',
  require 'file-tree',
  require 'debug-conf',
  require 'lsp.lsp-conf',
  require 'telescope-conf.telescope-conf',
  require 'auto-format-conf',
